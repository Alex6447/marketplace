"""Контракты движка наложения текста (стадия [6], docs_marketplace/plan.md, разделы 3 и 6).
...
маркетплейсов в эти примитивы — отдельные пункты Этапа 3 (см. docs_marketplace/plan.md, раздел 7).
"""
