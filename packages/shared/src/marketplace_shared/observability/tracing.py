"""Провайдеро-независимый трейсинг пайплайна (docs_marketplace/plan.md, разделы 2 и 7, Этап 5).
...
def get_tracer() -> Tracer:
    ...
    if provider in {"langfuse", "otel", "opentelemetry"}:
        ...
        log.warning(
            ...
            "использую логирующий трейсер (см. docs_marketplace/plan.md, Этап 6)",
            provider,
        )
        return LoggingTracer()
