...
> Выбор площадки/зоны (РФ/Европа/Китай) и помесячная стоимость при «модели по API» — [docs/hosting.md](hosting.md).
