...
См. docs_marketplace/plan.md, раздел 3 (стадия [5]) и раздел 4 (выбор инструментов). Основной
...
прямая митигация главного риска проекта — искажения товара (docs_marketplace/plan.md, раздел 8).
